'use client'
import { fetchTermsAndConditionsApi } from '@/server-api/apifunctions/apiService';
import React from 'react';

const privacyData = [
  {
    title: "Introduction",
    content: "Welcome to LuxMetallic Prepaid Cards Management Services. Your privacy is very important to us, and we are committed to protecting your personal information. This Privacy Policy outlines how we collect, use, and safeguard the information you provide when you use our customized ATM card services and visit our website.",
  },
  {
  ...
  },
  {
    ...
    content: "We prioritize the security of your personal and financial information. We implement robust security measures including encryption, secure servers, and access controls to protect your data from unauthorized access or breaches.",
  },
  {
  ...
  },
  {
    ...
    content: "Our website uses cookies to track user activity and store information about your preferences. You can manage or disable cookies through your browser settings.",
  },
  {
    title: "Changes to This Privacy Policy",
    content: "We may update this Privacy Policy from time to time. Any changes will be posted on this page, and we encourage you to review it periodically to stay informed about how we protect your privacy.",
  },
  {
    title: "Contact Us",
    content: [
    ...
    const TermsAndConditions = async ({ data }: any) => {

      const { title, content, modified } = await fetchTermsAndConditionsApi();
      
      // const effectiveDate = new Date(modified).toLocaleDateString("en-US", {
      //   year: "numeric",
      //   month: "long",
      //   day: "numeric",
      // });
          ...
          <div className=" mx-auto pages ">
            ...
            <div className="bg-gray-100 rounded-md py-8 px-4 text-black">
              ...
              <header className="text-center mb-8">
                <h1 className="text-4xl font-bold text-black">{title.rendered}</h1>
                {/* <p className="mt-4 text-lg text-gray-700">Effective Date: 23 Dec 2024</p> */}
              </header>
